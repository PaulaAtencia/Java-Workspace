public class t_8_1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "El siguiente primo mayor a 23 es " + Varias.siguientePrimo(23)
    );
    System.out.println(
      "El siguiente primo mayor a 100 es " + Varias.siguientePrimo(100)
    );
    ...
    System.out.println("Si al 78604321 se le quitan por delante 4 dígitos, se " +"queda como " +Varias.quitaPorDetras(78604321, 4));
    System.out.println("Si al 78604000 se le quitan por delante 2 dígitos, se " +"queda como " +Varias.quitaPorDetras(78604000, 2));
    ...
    System.out.println("Si al 567 se le pega por delate el 1 da el " + Varias.pegaPorDetras(567, 1));
    System.out.println("Si al 33 se le pega por delante el 0 da el " +Varias.pegaPorDetras(33, 0));
