public class t_8_7 {
  ...
  public static void main(String[] args) {
    ...
    switch (opcion) {
      ...
      case 5:
        resultado =
          Long.toString(binarioADecimal(octalABinario(numeroIntroducido)));
        break;
      case 6:
      ...
      case 8:
        resultado =
          Long.toString(
            binarioAOctal(decimalABinario((int) numeroIntroducido))
          );
        break;
      case 9:
        resultado =
          binarioAHexadecimal(decimalABinario((int) numeroIntroducido));
        break;
      case 10:
      ...
      case 11:
        resultado =
          Long.toString(
            binarioAOctal(hexadecimalABinario(numeroIntroducidoString))
          );
        break;
      case 12:
        resultado =
          Long.toString(
            binarioADecimal(hexadecimalABinario(numeroIntroducidoString))
          );
        break;
    }
  ...
  public static long hexadecimalABinario(String hexadecimal) {
    ...
    for (int i = 0; i < hexadecimal.length(); i++) {
      final long decimal = decimalABinario(
        digitosHexa.indexOf(hexadecimal.charAt(i))
      );
