public class t4_4 {
    ...
    System.out.printf("El sueldo correspondiente a % horas de trabajo, son %d euros", horasTrabajadas, totalSueldo);
    } 
    else if (horasTrabajadas > 40){
    horasExtra = horasTrabajadas - 40;
    totalSueldo = 40*eurosHora + horasExtra*eurosExtra;
    System.out.printf("El sueldo correspondiente a % horas de trabajo, son % euros", horasTrabajadas, totalSueldo);
    }
}
