public class t4_22 {
  ...
  public static void main(String[] args) {
    System.out.print(
      "Por favor, introduce un día de la semana de lunes a viernes: "
    );
    String dia = System.console().readLine().toLowerCase();
    System.out.print(
      "Por favor, introduce una hora en formato militar (las 10:46AM sería 1046): "
    );
    ...
    if ((hora < 0) || (hora > 23) || (min < 0) || (min > 59)) {
      ...
      switch (dia) {
        case "lunes":
          ...
          System.out.println(
            "Faltan " + falta + " minutos para el fin de semana"
          );
          break;
        case "martes":
